        ...
        <table width="500" align="center" style="background: #fff; padding:16px; border-radius: 6px; ">
            ...
            <tr>
                <td>
                    ...
                    <p style="margin: 4px 0;">> Your comapny not accepted by admin</p>

                   
                    @endif
                    <p style="margin: 4px 0;">> Your comapny is accepted by admin</p>

                    <p style="margin: 4px 0 16px; padding-bottom: 8px;"><b>Company Name:</b> 
                    </p>
